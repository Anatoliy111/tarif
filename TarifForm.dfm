inherited Tarifs: TTarifs
  ...
  object Panel6: TPanel [5]
    ...
    object cxGrid2: TcxGrid
      ...
      object cxGridDBTableView1: TcxGridDBTableView
        ...
        object cxGridDBTableView1LICH_PGK: TcxGridDBColumn
          Caption = #1050'-'#1089#1090#1100' '#1043#1082#1072#1083'. ('#1051#1110#1095'.)'
          DataBinding.FieldName = 'LICH_PGK'
          Options.Editing = False
        end
        ...
        object cxGridDBTableView1LICH_PGK2: TcxGridDBColumn
          Caption = #1050'-'#1089#1090#1100' '#1043#1082#1072#1083'. ('#1051#1110#1095'.) 2'
          DataBinding.FieldName = 'LICH_PGK2'
          Options.Editing = False
        end
  ...
  object IBTARIFUPD: TIBDataSet
    ...
    object IBTARIFUPDMZK_PDV: TIBBCDField
      FieldName = 'MZK_PDV'
      Origin = '"TARIF_MES"."MZK_PDV"'
      Precision = 18
      Size = 2
    end
    object IBTARIFUPDSUMMZK: TIBBCDField
      FieldName = 'SUMMZK'
      Origin = '"TARIF_MES"."SUMMZK"'
      Precision = 18
      Size = 2
    end
    object IBTARIFUPDSUMMZK_PDV: TIBBCDField
      FieldName = 'SUMMZK_PDV'
      Origin = '"TARIF_MES"."SUMMZK_PDV"'
      Precision = 18
      Size = 2
    end
    object IBTARIFUPDALLSUM: TIBBCDField
      FieldName = 'ALLSUM'
      Origin = '"TARIF_MES"."ALLSUM"'
      Precision = 18
      Size = 2
    end
    object IBTARIFUPDALLSUM_PDV: TIBBCDField
  ...
  object IBTARIF_OTHER: TIBDataSet
    ...
    InsertSQL.Strings = (
      'insert into TARIF_OTHER'
        ...
        '   SUMOT, SUMOTPDV, SENDPDV, LICH_PN, LICH_PK, LICH_PGK, LICH_GK' +
        ', LICH_PN2, '
  ...
  object dxMemData1: TdxMemData
    Indexes = <>
    Persistent.Data = {
      5665728FC2F5285C8FFE3F02000000040000000300040076616C000F00000001
      0005006C6963680001000000000109000000CBB3F7E8EBFCEDE8EA0101000000
      010D000000C1E5E720EBB3F72E20E3CAE0EB0102000000010E000000C1E5E720
    ...
    object dxMemData1lich: TStringField
      FieldName = 'lich'
      Size = 15
    end
  end
