...
type
  TMain = class(TForm)
    ...
    IBQREPBuh: TIBQuery;
    IBQREPBuhTARIFNAM: TIBStringField;
    IBQREPBuhADRES: TIBStringField;
    IBQREPBuhPLOS: TIBBCDField;
    IBQREPBuhGKAL: TIBBCDField;
    IBQREPBuhCENA: TIBBCDField;
    IBQREPBuhSUMOT: TIBBCDField;
    IBQREPBuhSUMOTPDV: TIBBCDField;
    IBQREPBuhTARIF_END: TIBBCDField;
    IBQREPBuhTARIF_ENDPDV: TIBBCDField;
    IBQREPBuhVID: TIBStringField;
    IBQREPBuhDATA: TDateField;
    IBQREPBuhID_POSL: TIntegerField;
    IBQREPBuhOTHER: TIntegerField;
    IBQREPBuhNO_LICH: TIntegerField;
